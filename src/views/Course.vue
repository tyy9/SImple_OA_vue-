<template>
  <div>
    ...
    <div class="tools" style="margin-top: 5px">
      <el-button type="primary" @click="openadd_dialog()">新增</el-button>
    ...
    <el-table :data="coursedata" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="id" label="课程id" width="140"> </el-table-column>
      <el-table-column prop="name" label="课程名称" width="120">
      </el-table-column>
      <el-table-column prop="score" label="学分" width="120"> </el-table-column>
      <el-table-column prop="times" label="学时" width="120"> </el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="open_editStudentInCourse(scope.row.id)"
            >编辑班级学生</el-button>

          <el-button size="mini" @click="findCourseById(scope.row.id)"
            >编辑</el-button
          >
          <el-button
            size="mini"
      ...
      <el-form :model="form" label-width="120px">
        ...
        <el-form-item label="课程主分类" :label-width="formLabelWidth">
          <el-select
            ...
            placeholder="请选择课程主分类"
            @change="getsubject_childrenList"
          >
            <el-option
        ...
        <el-form-item label="课程子分类" :label-width="formLabelWidth">
          <el-select
            ...
            placeholder="请选择课程子分类"
          >
            <el-option
              v-for="item in subject_childrenList"
              :key="item.id"
              :label="item.title"
              :value="item.id"
            ></el-option>
    ...
    <el-dialog
      ...
      width="100%"
    >
      <StudentOrder :course_selected="course_selected"></StudentOrder>
      <div slot="footer" class="dialog-footer">
        <el-button @click="close_editStudentInCourse">关闭</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    open_editStudentInCourse(id){
      this.dialogStudentFormVisible=true
      this.course_selected=id
    },
    close_editStudentInCourse(id){
